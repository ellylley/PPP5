            ...
            <div class="card-content">
                <div class="card-body">
                    <div class="list-group">
                        <?php if (isset($tugas_by_kelas[$kelas_item->id_kelas])): ?>
                            <?php foreach($tugas_by_kelas[$kelas_item->id_kelas] as $row): ?>
...
<script>
    ...
    $.ajax({
        url: '<?= site_url('home/getUsersByClass'); ?>/' + idKelas,
        type: 'GET',
